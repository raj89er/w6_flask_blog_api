...
class Post(db.Model):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.save()             ## this runs the save method along with the __init__ method, saving the post to the database. 
        ## p = Post(title='Hello', body='World', user_id=4) will create a new post with the title 'Hello', body 'World', and user_id 4.
